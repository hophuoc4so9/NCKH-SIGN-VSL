...
Sử dụng DETR Model backbone MobileNet

Cách sử dụng:
    python test_camera_mobile_net.py
...
# Import model
from model_mobile_net import DETR
# E:\git\SignDETR\model_test\MobileNet
MODEL_PATH = "E:\\git\\SignDETR\\model_test\\MobileNet\\best_signdetr_model.pth"
# MODEL_PATH = "E:\\git\\SignDETR\\model_test\\MobileNet\\checkpoint_epoch_100.pth"
...
def main():
    print("=" * 60)
    print("   SIGN LANGUAGE DETECTION - Camera Test (MobileNet)")
    print("=" * 60)
    ...
    while True:
        ...
        cv2.imshow('Sign Language Detection (MobileNet)', display)
