            ...
            with training_handler.create_training_progress() as epoch_progress:
                ...
                for batch_idx, batch in enumerate(train_dataloader): 
                    ...
                    try: 
                        ...
                        losses = loss_  dict['labels']['loss_ce']*weight_dict['class_weighting'] + loss_dict['boxes']['loss_bbox']*weight_dict['bbox_weighting'] + loss_dict['boxes']['loss_giou']*weight_dict['giou_weighting']
